...
<div>
  ...
  <tile-background theme="clouds">
    <blink delay="300"><header-text color="magenta" theme="fantasy">CLOUDS</header-text></blink>
  ...
  <tile-background theme="marble">
    <header-text theme="cool" color="red">MARBLE</header-text>
    <under-construction theme="professional"></under-construction>
  </tile-background>

  <tile-background theme="off-rock">
    <header-text theme="professional">OFF ROCK</header-text>
    <under-construction theme="professional"></under-construction>
  </tile-background>
